          ...
          <Box sx={{flex: '1 1 0%',}}>
              ...
              >
                ...
                />
                  ...
                  {country === "" || city === "" || bank === ""? 
                    <Button disabled type="submit" sx={{ height: 55, flex: '1 1 70%', fontSize: 14, fontWeight: 'bold',}} variant="contained" color="primary" /*onClick={() => window.open('/register_bank', "")}*/>Veuillez remplir tous les champs</Button> 
                    : 
